...
contract LoyaltySystem is Ownable, ReentrancyGuard {
    ...
    function previewPointsAvailableForRedemption(
        address user,
        uint256 ticketWei
    ) public view returns (uint256 availablePoints) {
    ...
    function awardPoints(
        ...
        require(
            weiAmount > 0,
            "Invalid transaction amount. Transaction amount should be greater than 0"
        );
